...
export class VideoService {
  ...
  create(token, video): Observable <any> {
    ...
    return this._http.post(this.url+'video/colectar', params, {headers:headers});
  }
  ...
  getVideo(token, id): Observable <any> {
    ...
    return this._http.get(this.url+'video/details/'+id, {headers:headers});
  }
  ...
  update(token, video, id): Observable <any> {
    ...
    return this._http.put(this.url+'video/editar/'+id, params, {headers:headers});
  }
